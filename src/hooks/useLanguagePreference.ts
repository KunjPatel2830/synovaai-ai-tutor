...
export const SUPPORTED_LANGUAGES = [
  ...
  { code: "hindi", name: "हिन्दी (Hindi)", bcp47: "hi-IN" },
  { code: "hinglish", name: "Hinglish", bcp47: "en-IN" },
  { code: "tamil", name: "தமிழ் (Tamil)", bcp47: "ta-IN" },
  { code: "telugu", name: "తెలుగు (Telugu)", bcp47: "te-IN" },
  { code: "bengali", name: "বাংলা (Bengali)", bcp47: "bn-IN" },
  { code: "marathi", name: "मराठी (Marathi)", bcp47: "mr-IN" },
  { code: "gujarati", name: "ગુજરાતી (Gujarati)", bcp47: "gu-IN" },
  { code: "kannada", name: "ಕನ್ನಡ (Kannada)", bcp47: "kn-IN" },
  { code: "malayalam", name: "മലയാളം (Malayalam)", bcp47: "ml-IN" },
  { code: "punjabi", name: "ਪੰਜਾਬੀ (Punjabi)", bcp47: "pa-IN" },
  { code: "urdu", name: "اردو (Urdu)", bcp47: "ur-IN" },
