    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12">
          <img src={synovaLogo} alt="SYNOVA Learning Platform" className="h-24 w-24 object-contain mb-8" />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <h1 className="sr-only">Sign in to SYNOVA Learning Platform</h1>
          {/* Theme Toggle */}
          ...
          <GlassCard variant="elevated">
            <GlassCardHeader className="text-center">
              <div className="lg:hidden mx-auto mb-4">
                <img src={synovaLogo} alt="SYNOVA Learning Platform" className="h-16 w-16 object-contain" />
              </div>
              <GlassCardTitle>
