...
export default function GamifiedDashboard() {
  ...
  return (
    <AppLayout>
      <div className="max-w-5xl mx-auto space-y-10 pb-12 px-2">
            ...
            <div className="space-y-2">
              {recentSessions.map((session) => (
                <div
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-muted/50 cursor-pointer transition-all duration-200 group"
                >
