...
NUMERICAL CONSISTENCY: For any generated numerical question, calculate the correct answer twice before writing JSON. The explanation and correctAnswer must match exactly. Never output a different correct answer than the worked explanation implies.
...
RESPONSE FORMAT (JSON only, no markdown):
{
  ...
  "focusAreas": ["area1", "area2"]
    ...
    if (choice?.finish_reason === "length") {
      return jsonResponse({ error: "AI response was cut off. Please try again." }, { status: 502 });
    }
